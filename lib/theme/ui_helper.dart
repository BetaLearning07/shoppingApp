...
class UIHelper {
  static double _VerticalSpaceExtraSmall = 4.0.h;
  static double _VerticalSpaceSmall = 8.0.h;
  static double _VerticalSpaceMedium = 16.0.h;
  static double _VerticalSpaceLarge = 24.0.h;
  static double _VerticalSpaceExtraLarge = 48.h;

  static double _HorizontalSpaceExtraSmall = 4.w;
  static double _HorizontalSpaceSmall = 8.0.w;
  static double _HorizontalSpaceMedium = 16.0.w;
  static double _HorizontalSpaceLarge = 24.0.w;
  static double _HorizontalSpaceExtraLarge = 48.0.w;
